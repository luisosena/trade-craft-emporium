    ...
    <footer className="bg-gray-100 mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="font-bold text-lg mb-4">TradeCraft Emporium</h3>
            <p className="text-sm text-gray-600">
              A marketplace connecting buyers and sellers with unique products.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to="/sell" className="hover:underline">Start Selling</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-600">
            © {new Date().getFullYear()} TradeCraft Emporium. All rights reserved.
          </p>
